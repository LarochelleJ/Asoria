...
public class Fighter {
    ...
    public void addBuff(int id, int val, int duration, int turns, boolean debuff, int spellID, String args, Fighter caster, boolean isPoison) {
        ...
        if (Config.DEBUG)
            GameServer.addToLog("Ajout du Buff " + id + " sur le personnage Fighter ID = " + this.getGUID() + "(" + caster.getGUID() + ") val : " + val + " duration : " + duration + " turns : " + turns + " debuff : " + debuff + " spellid : " + spellID + " args : " + args);
