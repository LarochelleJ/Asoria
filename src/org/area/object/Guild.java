...
public class Guild {
	...
	{
		GuildMember GM = new GuildMember(p.getGuid(),this,p.getName(),p.getLevel(),p.get_gfxID(),0,0,(byte) 0,0,p.get_align(),p.getAccount().getLastConnectionDate());
		_members.put(p.getGuid(),GM);
		return GM;
	}
	...
	public void removeMember(Player perso)
	{
		...
		_members.remove(perso.getGuid());
		SQLManager.DEL_GUILDMEMBER(perso.getGuid());
	}
