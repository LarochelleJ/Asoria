...
public class Constant {
    ...
    public static List<Integer> accountAllowed = Arrays.asList(11413, 27062, 1576, 177, 27061);
    ...
    public static final int CLASS_OUGINAK = 16;
    //GamePlay
    ...
    public static ObjTemplate getParchoTemplateByMountColor(int color) {
        switch (color) {
            ...
            //Balafreux
            case 91:
                return World.getObjTemplate(7036);
            //Kramkram
            case 92:
                return World.getObjTemplate(7037);
            //Hurledent
            case 93:
                return World.getObjTemplate(7038);
            //Dragouf
            case 94:
                return World.getObjTemplate(7039);
            //Dragodinde a plume
            case 95:
                return World.getObjTemplate(7040);
            //Sakochere
            case 96:
                return World.getObjTemplate(7041);
            //Bloupon griotte
            case 97:
                return World.getObjTemplate(895472);
            //Bloupon coco
            case 101:
                return World.getObjTemplate(895473);
            //Bloupon indigo
            case 102:
                return World.getObjTemplate(895474);
            //Bloupon reinette
            case 103:
                return World.getObjTemplate(895475);
            //Porcinet
            case 104:
                return World.getObjTemplate(895476);
            //Dardagnan
            case 105:
    ...
    public static int getNearCellidUnused(Player _perso) {
        ...
        if (_perso.getMap().getCase(_perso.get_curCell().getID() + cellFront).getDroppedItem() == null
            ...
            return cellFront;
        } else if (_perso.getMap().getCase(_perso.get_curCell().getID() - cellBack).getDroppedItem() == null
            ...
            return cellBack;
        } else if (_perso.getMap().getCase(_perso.get_curCell().getID() + cellRight).getDroppedItem() == null
            ...
            return cellRight;
        } else if (_perso.getMap().getCase(_perso.get_curCell().getID() - cellLeft).getDroppedItem() == null
